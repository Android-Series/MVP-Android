package com.jxq.mvp.common.lbs;
...
import com.jxq.mvp.common.util.SensorEventHelper;
...
public class GaodeLbsLayerImpl implements ILbsLayer {
    ...
    private static final String KEY_MY_MARKERE = "1000";//作为当前位置的标记点
    ...
    public GaodeLbsLayerImpl(Context context) {
        // 创建地图对象
        mapView = new MapView(context);//这个MapView之前是在mainactivity布局文件中定义的,我们可以直接在代码中去初始化
        // 获取地图管理器
        aMap = mapView.getMap();
        // 创建定位对象
    ...
    private void setUpMap() {
        ...
        aMap.setLocationSource(new LocationSource() {
            ...
            public void activate(OnLocationChangedListener onLocationChangedListener) {
                mMapLocationChangeListener = onLocationChangedListener; //地图更新的监听器的句柄就拿到了
                ...
                if (mMapLocationChangeListener != null) {
                    ...
                    if (firstLocation) {
                        ...
                        if (mLocationChangeListener != null) {
                            ...
                            mLocationChangeListener.onLocation(locationInfo);//首次调用
                        }
                    ...
                    if (mLocationChangeListener != null) {
                        ...
                        mLocationChangeListener.onLocationChanged(locationInfo);//非首次调用
                    }
                }
            }
        });
        mlocationClient.startLocation();//设置好监听后，启动定位
    }
